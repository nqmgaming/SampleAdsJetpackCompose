...
import com.nqmgaming.sampleadsjetpackcompose.Constant.INTERSTITIAL_ADS_ID
import com.nqmgaming.sampleadsjetpackcompose.Constant.REWARDED_INTERSTITIAL_ADS_ID
import com.nqmgaming.sampleadsjetpackcompose.Constant.REWARD_ADS_ID
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdLoaded(interstitialAd: InterstitialAd) {
                    ...
                    interstitialAd.onPaidEventListener =
                        OnPaidEventListener { p0 -> Toast.makeText(context, p0.toString(), Toast.LENGTH_SHORT).show() }
                }
        ...
        AndroidView(
            ...
            factory = { context ->
                AdView(context).apply {
                    ...
                    adUnitId = Constant.BANNER_ADS_ID
